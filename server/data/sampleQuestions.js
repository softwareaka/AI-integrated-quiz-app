export const sampleQuestions = [
  ...
  },
  {
    ...
    incorrectExplanations: {
      "HTML strings only": "React does not turn JSX into raw HTML strings for rendering logic; it creates element objects.",
      "Direct DOM manipulation": "React avoids direct DOM updates in application code; the reconciler updates the DOM from the virtual tree.",
  ...
  },
  {
    ...
    incorrectExplanations: {
      "201 Created": "201 is used when a new resource is created, commonly after POST, not a typical GET success.",
      "204 No Content": "204 means success with no body; GET responses usually include content, so 200 is more typical.",
